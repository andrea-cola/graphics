...
<<<<<<< HEAD
	let matrixTemp = utils.invertMatrix(worldMatrix);
	matrixTemp = utils.transposeMatrix(worldMatrix);
...
=======
	let inverseTransposeMatrix = [worldMatrix[0], worldMatrix[1], worldMatrix[2],
	worldMatrix[4], worldMatrix[5], worldMatrix[6],
	worldMatrix[8], worldMatrix[9], worldMatrix[10]]
	inverseTransposeMatrix = utils.invert3Matrix(inverseTransposeMatrix);
	gl.uniformMatrix3fv(program.nMatrixUniform, gl.FALSE, utils.transpose3Matrix(inverseTransposeMatrix));
>>>>>>> 09aece1135b96e4f98783c269b1e4cac7953e76d
...
function handleMouseClick(event) {
	...
	for (const [key, value] of Object.entries(positionDictionary)) {
		...
		var flagX = x - tollerance <= value.x && value.x <= x + tollerance;
		var flagY = y - tollerance <= value.y && value.y <= y + tollerance;
		if(flagX && flagY){
			alert(key);
...
<<<<<<< HEAD
		let matrixTemp = utils.invertMatrix(carMatrix);
		matrixTemp = utils.transposeMatrix(carMatrix);
...
<<<<<<< HEAD
		gl.uniformMatrix3fv(program.nMatrixUniform, gl.FALSE, inverseTransposeMatrix);
=======
		gl.uniformMatrix3fv(program.nMatrixUniform, gl.FALSE,
			utils.invert3Matrix(inverseTransposeMatrix));
>>>>>>> 09aece1135b96e4f98783c269b1e4cac7953e76d
		...
		positionDictionary[name] = { x: screenX, y: screenY };
	}
}
