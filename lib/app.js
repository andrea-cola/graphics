...
>>>>>>> aef9592f1b3b93f815bce3d8272f1b6f9db3ed2f


	for(let i=0; i<c.length; i++){
		imgtx2[i] = new Image();
		imgtx2[i].txNum = 1;
		imgtx2[i].onload = textureLoaderCallback;
		imgtx2[i].src = CarTextureData;
	}
...
var texturePointLoaderCallback = function () {
	var textureId = gl.createTexture();
	let city_index = this.txNum - 1;
...
>>>>>>> aef9592f1b3b93f815bce3d8272f1b6f9db3ed2f
		...
		perspectiveMatrix = utils.MakePerspective(90, w / h, 0.1, 1000.0);
...
function makeTextCanvas(text, width, height) {
	...
	// textCtx = canvas_text.getContext("2d");
	textCtx.canvas.width  = width;
	textCtx.canvas.height = height;
	textCtx.font = "8px monospace";
...
>>>>>>> aef9592f1b3b93f815bce3d8272f1b6f9db3ed2f
	...
	// ctx.fillText(name, canvas_2d.width/2, canvas_2d.height/2);
  ...
  if (gl.getParameter(gl.CURRENT_PROGRAM) == program) {
		...
		// gl.uniform1i(program.u_textureUniform, 1+index);
...
=======
	gl.uniform1i(program.u_textureUniform, 1);
	gl.uniform4f(program.lightDir, gLightDir[0], gLightDir[1], gLightDir[2], 1000);
	WVPmatrix = utils.multiplyMatrices(projectionMatrix, carMatrix);
	gl.uniformMatrix4fv(program.pMatrixUniform, gl.FALSE, utils.transposeMatrix(WVPmatrix));
	gl.uniformMatrix4fv(program.wMatrixUniform, gl.FALSE, utils.transposeMatrix(worldMatrix));
>>>>>>> aef9592f1b3b93f815bce3d8272f1b6f9db3ed2f
