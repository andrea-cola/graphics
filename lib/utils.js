...
// manual inversion
	...
	transpose3Matrix: function(m){
		return [m[0],m[3],m[6],m[1],m[4],m[7],m[2],m[5],m[8]]
	},
	identity3Matrix: function(){
		return [1,0,0,0,1,0,0,0,1]
	},
	invert3Matrix: function(m) {
		var det = m[0]*m[4]*m[8]+m[1]*m[5]*m[6]+m[2]*m[3]*m[7] - m[2]*m[4]*m[6]-m[0]*m[5]*m[7]-m[1]*m[3]*m[8]
		var tra = this.transpose3Matrix(m);
		var adj = [(tra[4]*tra[8]-tra[5]*tra[7])/det, -1*(tra[3]*tra[8]-tra[5]*tra[6])/det, (tra[3]*tra[7]-tra[4]*tra[6])/det,
							 -1*(tra[1]*tra[8]-tra[2]*tra[7])/det, (tra[0]*tra[8]-tra[2]*tra[6])/det, -1*(tra[0]*tra[7]-tra[1]*tra[6])/det,
		 					 (tra[1]*tra[5]-tra[2]*tra[4])/det, -1*(tra[0]*tra[5]-tra[2]*tra[3])/det, (tra[0]*tra[4]-tra[1]*tra[3])/det]

		return adj;
	},
	multiplyVectorMatrix: function(vector, matrix){
		return [vector[0]*matrix[0]+vector[1]*matrix[4]+vector[2]*matrix[8]+vector[3]*matrix[12],
